  ...
  return (
    <div className='accountpage'>
      ...
      <Box w="95%" m="auto" h="auto" mt="20px" borderTop="1px solid black">
        ...
        <Box w="100%" mt="20px" bgColor="#d2d9d4" borderBottom={"1px solid black"} display="flex" justifyContent={"space-around"} alignItmes="center">
          <Box w="15%" fontSize={["15px", "18px", "20px", "25px"]} >Sr no.</Box>
          <Box w="15%" fontSize={["15px", "18px", "20px", "25px"]} >Account holder</Box>
          <Box w="15%" fontSize={["15px", "18px", "20px", "25px"]} >email</Box>
          <Box w="15%" fontSize={["15px", "18px", "20px", "25px"]}>balance</Box>
          <Box w="15%" fontSize={["15px", "18px", "20px", "25px"]} ></Box>
        ...
        </Box>
        {
          data.length === 0 ? <h4 style={{ fontSize: "25px", marginTop: "20px" }}>... No transection</h4> : data.map((ele, index) => (
            <SimpleGrid p="10px 0" bgColor={index % 2 !== 0 ? "#d2d9d4" : "white"} w="100%" minChildWidth="200px" display="flex" justifyContent={"space-around"} alignItems="center">
              <Box w="10%" fontSize={["15px", "18px", "20px", "20px"]}>{index + 1}</Box>
              <Box w="15%" fontSize={["15px", "18px", "20px", "20px"]}>{ele.name}</Box>
              <Box w="15%" fontSize={["15px", "18px", "20px", "20px"]}>{ele.email}</Box>
