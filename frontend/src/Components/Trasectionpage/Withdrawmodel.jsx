...
const handleWithdraw=()=>{
  ...
  if(newamount<0){
    ...
    dispatch(updateProfile(token,{amount:newamount},{task:"amount added successfull"},onClose))
  }
...
<ModalContent >
  ...
  <ModalBody display={"flex"} flexDirection={["column", "column", "column", "column"]}>
    <Box display={"flex"} p="15px 15px" w={[  "auto","auto","auto","auto"]} className="scrollBox"  border="1px solid black" h="300px" flexDirection={"column"}   >
      ...
      <button style={{width:"200px",margin:"auto",marginTop:"20px"}} className="deposit-btn" onClick={handleWithdraw}   >Deposit</button>
